...
const ReviewForm = (props) => {
    ...
    const ratingOptions = [5, 4, 3, 2, 1].map( (score, index) => {
        return (
            <Fragment key={index}>
                <input type="radio" value={score} checked={props.review.score == score} id={`rating-${score}`} name="rating" onChange={() => console.log('selected:', score)} />
